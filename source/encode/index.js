     ...
     try {
         ...
         tmpl.JobTemplate.Settings.OutputGroups.forEach(group => {
             ...
             if (found) {
                 ...
                 console.log(`defaultGroup ${JSON.stringify(defaultGroup)}`);
                 console.log(`event customtemplate ${event.isCustomTemplate}`);
                 ...
                 console.log(`output group ${JSON.stringify(outputGroup)}` );
                 console.log(`job settings output group ${JSON.stringify(job.Settings.OutputGroups)}` );
         ...
         if (event.frameCapture) {
             ...
             console.log(`job settings output group frameCapture ${JSON.stringify(job.Settings.OutputGroups)}` );
         }
